...
This file is the quick-reference operating contract for serde-path-to-error-kotlin. The longer
...
serde-path-to-error-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`serde_path_to_error`](https://crates.io/crates/serde_path_to_error). Upstream Rust is the behavioral oracle while the
