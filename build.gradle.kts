...
kotlin {
    ...
    val xcf = XCFramework("SerdePathToError")

    macosArm64 {
        binaries.framework { baseName = "SerdePathToError"; xcf.add(this) }
    }
    iosArm64 {
        binaries.framework { baseName = "SerdePathToError"; xcf.add(this) }
    }
    ...
    swiftExport {
        moduleName = "SerdePathToError"
        flattenPackage = "io.github.kotlinmania.serdepathtoerror"
    }

    android {
        namespace = "io.github.kotlinmania.serdepathtoerror"
        compileSdk = 34
        minSdk = 24
...
mavenPublishing {
    ...
    coordinates(group.toString(), "serde-path-to-error-kotlin", version.toString())

    pom {
        name.set("serde-path-to-error-kotlin")
        description.set("Kotlin Multiplatform port of dtolnay/path-to-error - Path to the element that failed to deserialize")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/serde-path-to-error-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/serde-path-to-error-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/serde-path-to-error-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/serde-path-to-error-kotlin.git")
        }
    }
}
...
val fullTargetBuildTasks = listOf(
    ...
    "assembleSerdePathToErrorXCFramework",
    "assembleSerdePathToErrorDebugXCFramework",
    "assembleSerdePathToErrorReleaseXCFramework",
    "assembleDebugIosFatFrameworkForSerdePathToErrorXCFramework",
    "assembleReleaseIosFatFrameworkForSerdePathToErrorXCFramework",
    "assembleDebugIosSimulatorFatFrameworkForSerdePathToErrorXCFramework",
    "assembleReleaseIosSimulatorFatFrameworkForSerdePathToErrorXCFramework",
    "assembleDebugMacosFatFrameworkForSerdePathToErrorXCFramework",
    "assembleReleaseMacosFatFrameworkForSerdePathToErrorXCFramework",
    "assembleDebugTvosFatFrameworkForSerdePathToErrorXCFramework",
    "assembleReleaseTvosFatFrameworkForSerdePathToErrorXCFramework",
    "assembleDebugTvosSimulatorFatFrameworkForSerdePathToErrorXCFramework",
    "assembleReleaseTvosSimulatorFatFrameworkForSerdePathToErrorXCFramework",
    "assembleDebugWatchosFatFrameworkForSerdePathToErrorXCFramework",
    "assembleReleaseWatchosFatFrameworkForSerdePathToErrorXCFramework",
    "assembleDebugWatchosSimulatorFatFrameworkForSerdePathToErrorXCFramework",
    "assembleReleaseWatchosSimulatorFatFrameworkForSerdePathToErrorXCFramework",
